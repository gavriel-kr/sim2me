    ...
    <MainLayout>
      <div className="container mx-auto max-w-2xl px-4 py-12">
        ...
        <div className="prose prose-sm mt-6 text-muted-foreground whitespace-pre-line">
          {cms?.content || 'This Privacy Policy applies globally to all countries and customers worldwide.\n\nWe collect your email and payment information to process orders. We do not sell your data. For support we may use your contact details to respond.'}
        </div>
      </div>
    </MainLayout>
  );
