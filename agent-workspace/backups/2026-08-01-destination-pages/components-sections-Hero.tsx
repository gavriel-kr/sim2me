...
export function Hero() {
  ...
  // Same query key as HotDealsSection / ForYouSection Γאפ shared react-query cache, zero extra requests.
    ...
    <section className="relative overflow-hidden bg-gradient-hero">
      ...
      <div className="relative container mx-auto max-w-6xl px-4 py-16 sm:py-24 lg:py-28">
        {/*
          ...
          it Γאפ so any single element that cannot wrap silently widens the whole column, and the section
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          ...
          <div className="min-w-0 animate-fade-up">
            {/*
              ...
              badge at every width Γאפ leaving it to `flex-wrap` meant the line break depended on how
              ...
              is room for it, but on a phone the longest deal Γאפ "╫נ╫¿╫ª╫ץ╫¬ ╫פ╫ס╫¿╫ש╫¬ 100 GB ╫ס-$127.21 $139.80"
              Γאפ is wider than the screen, and a chip that cannot wrap forces the grid column wider than
                ...
                >
                  ...
                  <span key={strip[active].id} className="animate-in fade-in duration-500">
                    ...
                    {/*
                      ...
                      left-to-right, which parks the struck-through original against "╫ס-" and throws
                      ...
                      resolves to ltr whatever the surrounding script Γאפ a logical margin would answer
          ...
          */}
          {/*
            ...
            overlap is impossible Γאפ the card alone is 320 px of a 343 px column Γאפ so the two simply
