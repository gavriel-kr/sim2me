...
export function PlanCard({ plan, destinationName, destinationSlug }: PlanCardProps) {
  ...
  return (
    ...
    >
      ...
      {/*
        One strip per card. A plan on a hot deal wears the deal's own ribbon Γאפ the same amber-to-
        orange band the homepage uses Γאפ because the discount is the stronger message and two stacked
