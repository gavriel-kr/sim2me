...
/* ΓפאΓפאΓפא Filter presets (pills) + continuous slider ranges ΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפא */
...
/** Price slider: 0 = any, 1Γאף50 = up to $N, 51 = $50+ (min $50) */
...
/* ΓפאΓפאΓפא Pill button ΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפא */
...
/* ΓפאΓפאΓפא Compact filter slider with live value badge ΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפא */
...
/* ΓפאΓפאΓפא Simple info popover (click-based, works on mobile) ΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפא */
...
export function DestinationDetailClient({
  ...
  // does not really beat Γאפ and the shelf would reshuffle itself at midnight when the deal expires,
  ...
  */
  ...
  /** Map weekly GB estimate from calculator Γזע continuous GB filter */
  ...
  const handleCalcFindPlan = useCallback((weeklyGB: number) => {
    ...
    openCatalog(); // the data filter lives in the full catalog Γאפ make it visible
  }, [openCatalog]);
  ...
  const plans = useMemo(() => {
    ...
    // Price filter: 1Γאף50 = up to $N; 51 = $50+
  ...
  useEffect(() => {
    ...
    } catch { /* storage unavailable Γאפ non-critical */ }
  }, [destination.slug, destination.isoCode, destination.name]);

  return (
    <div className="container px-4 py-8">
      {/* ΓפאΓפאΓפא Country header ΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפא */}
      ...
      {/* ΓפאΓפאΓפא Calculator nudge (opens popup) ΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפא */}
      ...
      {/* ΓפאΓפאΓפא Smart shelf: curated trip-intent tiers (always visible) ΓפאΓפאΓפא */}
      {canCurate && (
      ...
      {/* ΓפאΓפאΓפא Filter bar (glassmorphism, highlighted) ΓפאΓפאΓפא */}
      <div className="relative mt-3 overflow-hidden rounded-3xl border border-emerald-100/90 bg-white/80 shadow-lg shadow-emerald-900/5 backdrop-blur-md">
        ...
        {/* Network pills Γאף only show if 5G is available */}
        {has5G && (
      ...
      {/* ΓפאΓפאΓפא Result count ΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפא */}
      ...
      {/* ΓפאΓפאΓפא Plans grid ΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפא */}
      ...
      {/* ΓפאΓפאΓפא Empty state ΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפאΓפא */}
      {plans.length === 0 && (
