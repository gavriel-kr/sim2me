    ...
    <section className="relative bg-gradient-to-b from-muted/30 to-white py-20 sm:py-24">
      <div className="container px-4">
        {/*
          ...
          Sides alternate down the page Γאפ deals at the inline start, the daily pick at the end, here
          back at the start, the FAQ at the end Γאפ so the characters zigzag instead of stacking into a
