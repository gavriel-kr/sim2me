...
- Inspect every cutout on a **dark** background before accepting it (`--proof` does this), and on
  hair use `zoom-edge.mjs`. Leftover background is invisible on white and obvious on navy.
